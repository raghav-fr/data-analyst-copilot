    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden" style={{ background: "var(--bg-primary)" }}>
      ...
      >
        ...
        <div className="mt-6 flex items-center justify-between">
          ...
          <span className="text-xs text-center uppercase" style={{ color: "var(--text-muted)" }}>or sign in with</span>
          <span className="w-1/5 border-b lg:w-1/4" style={{ borderColor: "var(--border)" }}></span>
        </div>
        ...
        <p className="text-center text-sm mt-8" style={{ color: "var(--text-muted)" }}>
          ...
          <Link href="/signup" className="font-medium transition-colors hover:opacity-80" style={{ color: "var(--accent)" }}>
            Create one now
          </Link>
        </p>
      </motion.div>
